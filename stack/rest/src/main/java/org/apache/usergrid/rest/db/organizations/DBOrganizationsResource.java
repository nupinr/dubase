...
public class DBOrganizationsResource extends AbstractContextResource {
    ...
    public DBOrganizationsResource() {
    }
    ...
    public DBOrganizationResource getOrganizationById( @Context UriInfo ui,
        ...
        return getSubResource( DBOrganizationResource.class ).init( organization );
    }

    @Path( "{organizationName}" )
    public DBOrganizationResource getOrganizationByName( @Context UriInfo ui,
